...
text_result = tk.Text(root, height=2, width=16, font=("Arial", 24),bg='Blue', fg='white')
...
btn_0=tk.Button(root,text='0',command= lambda:add_to_calculation(0), width=14, font=("Arial",14))
...
btn_pwr=tk.Button(root,text='^',command= lambda:add_to_calculation('**'), width=5, font=("Arial",14))
btn_pwr.grid(row=2,column=3)

btn_clear= tk.Button(root,text='Clear', command= clear_field, width=14, font=("Arial",14))
